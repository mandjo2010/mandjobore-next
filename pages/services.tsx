...
export default function ServicesPage({ page, pages }: ServicesPageProps) {
  return (
    <>
      <Head>
        <title>{page.title} - mandjobore.com</title>
        <meta name="description" content="Services de développement web et analyse de données par Mandjo Béa Boré" />
      </Head>
      ...
      <GatsbyLayoutNew
        ...
        parts={[]}
        seo={{
          description: 'Services de développement web et analyse de données',
...
export const getStaticProps: GetStaticProps<ServicesPageProps> = async () => {
  ...
  const pageData = getBySlug('pages', '5--services')
