...
const theme = createTheme({
	// 🔁 Copie fidèle de tes tokens custom
	base: {
		colors: {
	...
	info: {
		...
		sizes: { width: 320, headerHeight: 170 },
		fonts: { boxTitleSize: 1.3, boxTitleSizeM: 1.5, boxTitleSizeL: 1.7 },
	},
	navigator: {
		colors: {
			background: colors.background,
	...
	footer: {
		...
		fonts: { footnote: { size: 0.8, lineHeight: 1.4 } },
	},
	bars: {
		colors: {
			background: colors.background,
	...
	mediaQueryTresholds: { M: 600, L: 1024 },
