...
const techLogos = [
  { name: 'Next.js', icon: '▲', textColor: 'text-black', url: 'https://nextjs.org' },
  { name: 'React', icon: '⚛️', textColor: 'text-blue-500', url: 'https://reactjs.org' },
  { name: 'TypeScript', icon: 'TS', textColor: 'text-blue-600', url: 'https://typescriptlang.org' },
  { name: 'JavaScript', icon: 'JS', textColor: 'text-yellow-500', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
  { name: 'Tailwind', icon: '💨', textColor: 'text-cyan-500', url: 'https://tailwindcss.com' },
  { name: 'Vercel', icon: '▲', textColor: 'text-gray-900', url: 'https://vercel.com' },
  { name: 'Git', icon: '⚡', textColor: 'text-orange-600', url: 'https://git-scm.com' },
  { name: 'VSCode', icon: '⟨⟩', textColor: 'text-blue-500', url: 'https://code.visualstudio.com' },
  { name: 'Node.js', icon: '⬢', textColor: 'text-green-600', url: 'https://nodejs.org' }
]
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="p-8 border-t border-gray-100">
          <div className="text-center mb-6">
            ...
            {/* Grille 3x3 des technologies - Logos agrandis sans bordures */}
              ...
              {techLogos.map((tech) => (
                <div key={tech.name} className="flex justify-center">
                  <a
                    ...
                    className={`text-2xl ${tech.textColor} hover:scale-110 transition-transform duration-200 cursor-pointer`}
                    title={tech.name}
