...
const techLogos = [
  ...
  { name: 'Redux', icon: '🔄', textColor: 'text-purple-600' },
  { name: 'Material-UI', icon: 'MUI', textColor: 'text-blue-700' },
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="p-8 border-t border-gray-100">
          <div className="text-center mb-6">
            ...
            {/* Grille des technologies avec deuxième ligne centrée */}
            <div className="mb-6">
              {/* Première ligne - 6 logos */}
              <div className="grid grid-cols-6 gap-2 mb-2">
                {techLogos.slice(0, 6).map((tech, index) => (
                  <div key={tech.name} className="flex justify-center">
                    <a
                      ...
                      title={tech.name}
                    >
                      <span className={`text-xl ${tech.textColor || 'text-gray-600'}`}>
                        {tech.icon}
                      </span>
                    </a>
                  </div>
              ...
              <div className="flex justify-center gap-12">
                {techLogos.slice(6).map((tech, index) => (
                  <div key={tech.name} className="flex justify-center">
                    <a
                      href={getTechUrl(tech.name)}
                      target="_blank"
